...
function Achivements() {
    ...
    if (!Array.isArray(achivements) || achivements.length === 0) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 px-4">
                ...
                >
                    <p className="text-gray-600 text-2xl mb-4">🏆 No achievements yet</p>
                    <p className="text-gray-500">Check back soon for our latest accomplishments!</p>
                </motion.div>
            </div>
        );
    }
    ...
    return (
        <div className="w-full min-h-screen py-12 px-4 md:px-8 bg-gradient-to-br from-gray-50 to-purple-50">
            <motion.div
